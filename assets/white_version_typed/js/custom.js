...
const observer = new IntersectionObserver((entries) => {
  entries.forEach((entry) => {
    const animationDirection = entry.target.dataset.animate;
    const animationClassName =
      animationDirection === "right"
        ...
        ? "ts-fadeInUp"
        : animationDirection === "zoomin"
        ? "ts-zoomInShort"
        : animationDirection === "zoomout"
        ? "ts-zoomOutIn"
        : ""; // Default to no animation if data-animate doesn't match
...
// Target elements with any of the data-animate attributes
